...
async function setup (options = {}) {
  ...
  // For just plain kubernetes,  we need to first detect that they have minikube running
  // Then get the env exports for the docker daemon inside minikube
  // Figure out the current namespace they are on?
  // How does kube log in?
